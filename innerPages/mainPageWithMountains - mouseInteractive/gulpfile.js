...
let source_folder = "#mainPageWithMountains - mouseInteractive";
...
let path = {
  build: {
    ...
    js_plugins: project_folder + "/js/js_plugins/",
  ...
  src: {
    ...
    js_plugins: source_folder + "/js/js_plugins/*.js",
...
const watchFiles = () => {
  ...
  gulp.watch([path.watch.js_plugins], js_plugins);
